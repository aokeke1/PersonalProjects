...
##        self.recordBoard()
    ...
    ##                            self.checkRemainingBlackPieces()
                            ...
                            self.rows[checkcoord[0]].setRowPos(checkcoord[1], "_")
                            self.cols[checkcoord[1]].setColPos(checkcoord[0], "_")
                            

                        self.rows[startcoord[0]].setRowPos(startcoord[1], "_")
                        self.rows[endcoord[0]].setRowPos(endcoord[1], piece)
                        self.cols[startcoord[1]].setColPos(startcoord[0], "_")
                        ...
                        if piece == "King" and start == "E1" and end == "C1":
                            ...
                            self.rows[startcoord2[0]].setRowPos(startcoord2[1], "_")
                            self.rows[endcoord2[0]].setRowPos(endcoord2[1], piece2)
                            self.cols[startcoord2[1]].setColPos(startcoord2[0], "_")
